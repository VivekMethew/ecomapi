...
router.get('/get_categorys', verifyAccessToken, categoryController.category_list)
router.get('/get_category/:catid', verifyAccessToken, categoryController.category)
